...
fun ChatOrders(
    ...
    orderViewModel: ChatOrderViewModel = hiltViewModel()
) {
...
//                    IconButton(onClick = {
//                        orderViewModel.event(ChatOrdersEvent.Logout)
//                        activity?.finish()
//                    }) {
//                        Icon(
...
//                    }
        ...
        floatingActionButton = {
            FloatingActionButton(onClick = {
                navController.navigate(AddChatOrder)
            }) {
            ...
            LazyColumn(
                ...
                itemsIndexed(state.successOrders) { index, order ->
                    ...
                    if (index == state.successOrders.lastIndex) {
                        LaunchedEffect(Unit) {
                            orderViewModel.event(ChatOrdersEvent.LoadOrders)
                        }
                    }
