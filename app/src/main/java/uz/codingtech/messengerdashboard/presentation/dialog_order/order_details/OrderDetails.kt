...
fun OrderDetails(
    ...
    orderId: Int,
    orderViewModel: OrderDetailsViewModel = hiltViewModel()
) {
    ...
    if (showCancelDialog) {
        AlertDialog(
            ...
            confirmButton = {
                TextButton(
                    onClick = {
                        orderViewModel.event(OrderDetailEvent.Cancel(orderId))
    ...
    LaunchedEffect(Unit) {
        ...
        orderViewModel.event(OrderDetailEvent.InitOrderDetail(orderId))
    }
